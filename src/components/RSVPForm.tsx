 ...
 * RSVP.
 *
 * Two answers, both graceful. Validation happens on submit and speaks like a
 * person; the guest counter cannot be pushed out of range by buttons, typing
 * or a pasted value; and a response already sent from this device is
 * remembered so nobody wonders whether it went through.
 */
